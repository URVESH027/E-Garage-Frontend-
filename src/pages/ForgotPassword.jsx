        ...
        <div className="relative overflow-hidden bg-[#171717] p-8 text-white sm:p-10 lg:p-12">
          ...
          <div className="relative h-full flex flex-col justify-center">
            ...
            <p className="mt-5 max-w-md text-sm leading-7 text-slate-300">
              Enter your registered email and we will generate a reset link for your account.
            </p>
          </div>
        </div>
        ...
        <div className="bg-[#fffaf2] p-8 sm:p-10 lg:p-12 flex items-center">
          <div className="mx-auto max-w-md w-full">
            ...
            <form onSubmit={handleSubmit(submitHandler)} className="mt-8 grid gap-5">
              ...
              {resetLink && (
                <div className="rounded-[22px] bg-[#fff2dc] px-4 py-3 text-sm font-semibold text-[#7f3c23]">
                  Development reset link:
                  <a href={resetLink} className="mt-2 block break-all font-bold text-[#9a4d31] underline">
                    {resetLink}
                  </a>
                </div>
              )}
